...
<head>
    ...
    <link rel="icon" href="#">
    <title>COLORFUL EXPRESSIONS </title>
    ...
    <div class="container">
        <div class="row align-items-center">
            ...
            <div class="col-6 col-md-6">
                <a href="{{ url('/colorful-expressions') }}">
                    <img class="logo" src="{{ asset('/images/logos/colorful-expressions-removebg-preview.png') }}" alt="Logo"
                         style="height: 100px;">
                </a>
            </div>
...
<nav style="background-color: #cb0096;" class="navbar navbar-expand-lg navbar-dark {{--bg-secondary--}}">
    <div class="container">
        <!-- Brand and toggle get grouped for better mobile display -->
        ...
        <div class="collapse navbar-collapse" id="navbarSecondary">
            ...
            <ul class="navbar-nav {{--ml-auto--}}">
                <li class="nav-item">
                    <a style="color: white;" class="nav-link" href="{{ url('/colorful-expressions') }}">Colorful Expression</a>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item">
                    <a style="color: white;" class="nav-link" href="{{ url('#call-to-action') }}">Call To Action</a>
                </li>
